        ...
        if (selectCategoria) {
            ...
            setTimeout(() => {
                ...
                if (selectAlumno) {
                    ...
                    // NUEVO: Enviar el formulario automáticamente
                    const formReporteIndividual = document.getElementById('form-reporte-individual');
                    if (formReporteIndividual) {
                        formReporteIndividual.submit();
                    }
                }
            }, 1000);
        }
...
document.addEventListener('DOMContentLoaded', function() {
    // AÑADIDO AL INICIO: Verificar si hay parámetro tab en la URL
    const urlParams = new URLSearchParams(window.location.search);
    const tab = urlParams.get('tab');
    
    console.log('URL params:', urlParams.toString()); // AÑADIDO para debug
    console.log('Tab solicitado:', tab); // AÑADIDO para debug
    
    if (tab === 'entrenamientos') {
        console.log('Activando pestaña de entrenamientos...'); // AÑADIDO para debug
        
        // Buscar la pestaña de entrenamientos usando el atributo data-target
        const entrenamientosTab = document.querySelector('[data-target="#entrenamientos"]');
        const entrenamientosSection = document.getElementById('entrenamientos');
        
        console.log('Tab encontrado:', entrenamientosTab); // AÑADIDO para debug
        console.log('Sección encontrada:', entrenamientosSection); // AÑADIDO para debug
        
        if (entrenamientosTab && entrenamientosSection) {
            // Desactivar todas las pestañas
            const allTabs = document.querySelectorAll('.menu li');
            const allSections = document.querySelectorAll('[data-content]');
            
            allTabs.forEach(t => t.classList.remove('active'));
            allSections.forEach(s => s.classList.remove('active'));
            
            // Activar la pestaña y sección de entrenamientos
            entrenamientosTab.classList.add('active');
            entrenamientosSection.classList.add('active');
            
            console.log('Pestaña activada correctamente'); // AÑADIDO para debug
            
            // Hacer scroll suave hacia la sección después de un breve delay
            setTimeout(() => {
                entrenamientosSection.scrollIntoView({ 
                    behavior: 'smooth', 
                    block: 'start' 
                });
            ...
            console.error('No se encontró la pestaña o sección de entrenamientos'); // AÑADIDO para debug
        }
    }
    ...
    // Hacer scroll automático al reporte grupal cuando se genera
    ...
    // Hacer scroll automático al reporte individual cuando se genera
    ...
    // Controlar la visibilidad del botón "Volver al Reporte Grupal"
    ...
    // Manejar el submit del formulario de entrenamientos
    ...
    // Manejar clics en filas de entrenamientos
    ...
    // Si hay filtros aplicados, cambiar automáticamente a la pestaña de entrenamientos
    ...
    // Manejar el submit del formulario de filtros
...
// ...existing code... (resto de funciones fuera del DOMContentLoaded)