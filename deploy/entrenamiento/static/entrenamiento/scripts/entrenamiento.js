document.addEventListener('DOMContentLoaded', function() {
    ...
    function inicializarFormularioCrear() {
        ...
        // Contadores de caracteres para crear
        if (crearNombreInput) {
            ...
            crearNombreInput.parentElement.appendChild(contadorNombre);
        ...
        if (crearDescripcionTextarea) {
            ...
            crearDescripcionTextarea.parentElement.appendChild(contadorDescripcion);
        ...
        if (formCrear) {
            formCrear.addEventListener('submit', function(e) {
                ...
                if (!categoria || categoria === '') {
                    ...
                    document.getElementById('crear_categoria').focus();
                    return;
                }
